...
<main>
    <!-- ① fv -->
    <section class="fv" id="fv" style="background-image:url('<?php echo get_template_directory_uri() . '/images/kv_v2.png'; ?>');
    ...
    <section class="about" id="about">
        <div class="container about_inner">
            ...
            <div class="about_images">
                <img src="<?php echo get_template_directory_uri() . '/images/about_img_1_v2.png'; ?>" alt="庭園の景色" class="main_image">
                <img src="<?php echo get_template_directory_uri() . '/images/about_img_2_v2.png'; ?>" alt="料理" class="sub_image">
            </div>
        </div>
    </section>
                ...
                <article class="blog_card">
                    <a href="<?php the_permalink(); ?>" class="blog_card_link">
                        ...
                        <div class="blog_content">
                            ...
                            <?php
                                /* ---------- カテゴリー配列を取得 ---------- */
                                $cats         = get_the_category();                 // 全カテゴリ
                                $extra_count  = $cats ? max( 0, count( $cats ) - 1 ) : 0; // 先頭以外の件数
                            ...
                            <div class="blog_category_tag_wrapper<?php echo esc_attr( $multi_class ); ?>"<?php echo $data_attr; ?>>
                                <?php if ( $cats ) : ?>
                                    <span class="blog_category_tag"><?php echo esc_html( $cats[0]->name ); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </a>
